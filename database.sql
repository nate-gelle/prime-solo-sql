...
UPDATE accounts SET account_balance=100 WHERE account_balance=0; 
...
-- 8. Add a new record.
INSERT INTO accounts (username, city, transactions_completed, transactions_attempted, account_balance) VALUES ('ngelle', 'minneapolis', 5, 20, 6.50);
